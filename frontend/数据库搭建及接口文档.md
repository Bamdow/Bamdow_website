...
#### 4.2.1 Markdown 文件表 (markdown_files)
```sql
...
#### 4.2.2 Markdown 图片表 (markdown_images)
```sql
...
### 4.3 Markdown Java 类设计

#### 4.3.1 Markdown 文件实体类 (MarkdownFile)
```java
import lombok.Data;
import java.sql.Timestamp;
...
#### 4.3.2 Markdown 图片实体类 (MarkdownImage)
```java
import lombok.Data;
import java.sql.Timestamp;
